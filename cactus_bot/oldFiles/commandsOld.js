...
const client = require(`./botOld.js`);
...
client.once('ready', async () => {
  rest.put(Routes.applicationCommands(client.user.id), { body: commands }).then(async()=> {console.log(`Successfully reloaded application (/) commands for all ${client.guilds.cache.size} guilds.`)}).catch(console.error);
